            ...
            <div class="container">
                <div class="card">
                    <div class="card-header bg-success">
                        <h2 class="text-center">Customer DataTable </h2>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('delete.user',$item->id)}}" onclick="return confirm('Are you sure to Delete')" class="btn btn-danger">Delete</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{route('update.user',$item->id)}}"method="POST">
                ...
                <div class="form-group">
                    <label for="email">User Name:</label>
                    <input type="text" class="form-control" name="name" value="{{$item->name}}" id="email">
                  </div>
                <div class="form-group">
                  <label for="email">Email address:</label>
